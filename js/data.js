...
MB.prices = [
  ...
  { mandi: "sri-ganganagar", crop: "sarson", min: 7506, modal: 7789, max: 7898, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "jaipur", crop: "chana", min: 5650, modal: 5711, max: 5772, vs: 0, arrivals: "low", date: "2026-08-22", fresh: false },
  ...
  { mandi: "jaipur", crop: "bajra", min: 2070, modal: 2100, max: 2131, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "unjha", crop: "jeera", min: 16055, modal: 19375, max: 22575, vs: 0, arrivals: "high", date: "2026-08-22", fresh: false },
  ...
  { mandi: "jaipur", crop: "gwar", min: 5618, modal: 5618, max: 5618, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "jaipur", crop: "aalu", min: 1700, modal: 1850, max: 2000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "kota", crop: "tamatar", min: 1100, modal: 1300, max: 1500, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "jaipur", crop: "tamatar", min: 3000, modal: 3200, max: 3400, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "gondal", crop: "tamatar", min: 900, modal: 1800, max: 2700, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "gondal", crop: "gwar", min: 3000, modal: 5500, max: 8000, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "gondal", crop: "aalu", min: 650, modal: 950, max: 1250, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  ...
  { mandi: "jaipur", crop: "pyaz", min: 3200, modal: 3400, max: 3600, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "ujjain", crop: "tamatar", min: 650, modal: 1384, max: 2135, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  ...
  { mandi: "jaipur", crop: "sarson", min: 7531, modal: 7765, max: 8000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "jalore", crop: "tamatar", min: 2000, modal: 2200, max: 2400, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "unjha", crop: "sarson", min: 7375, modal: 8190, max: 8955, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "mehsana", crop: "aalu", min: 500, modal: 1100, max: 1500, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "mehsana", crop: "pyaz", min: 2000, modal: 3250, max: 4000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "mehsana", crop: "tamatar", min: 60, modal: 70, max: 80, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "mehsana", crop: "sarson", min: 7520, modal: 7550, max: 7590, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "mehsana", crop: "gehun", min: 2300, modal: 2600, max: 2755, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "ramganj", crop: "aalu", min: 400, modal: 500, max: 550, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "ramganj", crop: "pyaz", min: 1100, modal: 3350, max: 4500, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ramganj", crop: "tamatar", min: 800, modal: 1800, max: 2700, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ramganj", crop: "gehun", min: 2300, modal: 2375, max: 2450, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "ramganj", crop: "makka", min: 2050, modal: 2067, max: 2100, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  ...
  { mandi: "sri-ganganagar", crop: "chana", min: 5496, modal: 5496, max: 5496, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "jalore", crop: "adrak", min: 4500, modal: 4800, max: 5000, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "jalore", crop: "hara-dhaniya", min: 3000, modal: 3200, max: 3400, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "jaipur", crop: "jau", min: 2410, modal: 2475, max: 2540, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "unjha", crop: "saunf", min: 8090, modal: 9875, max: 18300, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "mehsana", crop: "kela", min: 1500, modal: 2250, max: 2500, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "mehsana", crop: "bajra", min: 2000, modal: 2375, max: 2605, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "mehsana", crop: "arandi", min: 6950, modal: 7132, max: 7165, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "gondal", crop: "seb", min: 4000, modal: 11000, max: 18000, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "gondal", crop: "kela", min: 1500, modal: 2150, max: 2800, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "gondal", crop: "anar", min: 1500, modal: 5500, max: 9500, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "gondal", crop: "amrood", min: 2000, modal: 5000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  ...
  { mandi: "ujjain", crop: "adrak", min: 575, modal: 1328, max: 2435, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "ujjain", crop: "hara-dhaniya", min: 550, modal: 1264, max: 2300, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  ...
  { mandi: "ramganj", crop: "amrood", min: 2000, modal: 4000, max: 10000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ramganj", crop: "anar", min: 5000, modal: 8000, max: 11000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ramganj", crop: "seb", min: 4000, modal: 12000, max: 18000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ramganj", crop: "adrak", min: 7500, modal: 12000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ramganj", crop: "hara-dhaniya", min: 8000, modal: 10000, max: 12000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ramganj", crop: "hara-matar", min: 3000, modal: 3106, max: 10000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ramganj", crop: "dhan", min: 1900, modal: 1900, max: 2240, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "ramganj", crop: "kela", min: 500, modal: 600, max: 750, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  ...
  { mandi: "ramganj", crop: "sarson", min: 6501, modal: 7126, max: 7751, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  ...
  { mandi: "jalore", crop: "aalu", min: 1200, modal: 1300, max: 1500, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  ...
  { mandi: "ramganj", crop: "hari-mirch", min: 2500, modal: 4000, max: 6000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "jalore", crop: "hari-mirch", min: 1500, modal: 1600, max: 1800, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  { mandi: "mehsana", crop: "hari-mirch", min: 1000, modal: 2000, max: 3800, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "gondal", crop: "hari-mirch", min: 1000, modal: 3500, max: 6000, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
  ...
  { mandi: "ujjain", crop: "hari-mirch", min: 625, modal: 1347, max: 2450, vs: 0, arrivals: "med", date: "2026-08-23", fresh: true },
];
