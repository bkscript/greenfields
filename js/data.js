...
MB.PRICE_DATE = "2026-08-27";
MB.LAST_UPDATED_DATE = "2026-08-27";
MB.BRAND_HI = "फसल भाव";
...
MB.prices = [
  ...
  { mandi: "jaipur", crop: "gehun", min: 2465, modal: 2543, max: 2622, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "gehun", min: 2600, modal: 2600, max: 2600, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "gehun", min: 2280, modal: 2701, max: 3100, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "ujjain", crop: "gehun", min: 2000, modal: 2338, max: 3020, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "gehun", min: 2580, modal: 2725, max: 3360, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "sarson", min: 7700, modal: 7700, max: 7700, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "sarson", min: 7150, modal: 7550, max: 7849, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sri-ganganagar", crop: "sarson", min: 7642, modal: 7642, max: 7642, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "indore", crop: "sarson", min: 6795, modal: 7500, max: 7500, vs: 0, arrivals: "low", date: "2026-08-22", fresh: false },
  { mandi: "indore", crop: "chana", min: 4000, modal: 7588, max: 9485, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "ujjain", crop: "chana", min: 3913, modal: 5661, max: 5662, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "kota", crop: "chana", min: 5400, modal: 5400, max: 5400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jaipur", crop: "chana", min: 5850, modal: 5850, max: 5850, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  ...
  { mandi: "jodhpur", crop: "bajra", min: 1500, modal: 2000, max: 2400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jaipur", crop: "bajra", min: 1860, modal: 2005, max: 2151, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "sri-ganganagar", crop: "bajra", min: 2060, modal: 2160, max: 2230, vs: 12, arrivals: "low", date: "2026-08-22", fresh: false },
  { mandi: "deesa", crop: "bajra", min: 2305, modal: 2425, max: 2575, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "makka", min: 2300, modal: 2453, max: 2453, vs: 0, arrivals: "high", date: "2026-08-25", fresh: false },
  { mandi: "harda", crop: "makka", min: 2250, modal: 2375, max: 2375, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "makka", min: 2200, modal: 2200, max: 2200, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "makka", min: 2200, modal: 2280, max: 2350, vs: 30, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "rajkot", crop: "kapas", min: 7750, modal: 9250, max: 9855, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "amreli", crop: "kapas", min: 5500, modal: 9525, max: 10250, vs: 0, arrivals: "high", date: "2026-08-25", fresh: false },
  { mandi: "gondal", crop: "kapas", min: 5855, modal: 9705, max: 9805, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "kapas", min: 6800, modal: 7100, max: 7450, vs: 0, arrivals: "low", date: "2026-08-22", fresh: false },
  { mandi: "gondal", crop: "moongphali", min: 4500, modal: 6755, max: 7880, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "amreli", crop: "moongphali", min: 4500, modal: 6625, max: 7000, vs: 0, arrivals: "high", date: "2026-08-25", fresh: false },
  { mandi: "rajkot", crop: "moongphali", min: 6450, modal: 7050, max: 7755, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "unjha", crop: "jeera", min: 16800, modal: 19500, max: 22650, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "jeera", min: 15000, modal: 17500, max: 19850, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "nagaur", crop: "jeera", min: 16000, modal: 16650, max: 17200, vs: 50, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "merta", crop: "jeera", min: 15200, modal: 18200, max: 20700, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "unjha", crop: "isabgol", min: 14200, modal: 14800, max: 15100, vs: -100, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "merta", crop: "isabgol", min: 11200, modal: 11900, max: 12500, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  ...
  { mandi: "merta", crop: "gwar", min: 5300, modal: 5650, max: 5940, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "gwar", min: 6000, modal: 6000, max: 6000, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  ...
  { mandi: "gondal", crop: "pyaz", min: 905, modal: 2955, max: 5355, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "pyaz", min: 723, modal: 2944, max: 3655, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "deesa", crop: "aalu", min: 800, modal: 1050, max: 1300, vs: 0, arrivals: "high", date: "2026-08-25", fresh: false },
  { mandi: "indore", crop: "aalu", min: 914, modal: 914, max: 914, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "jaipur", crop: "aalu", min: 2000, modal: 2200, max: 2400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "aalu", min: 650, modal: 650, max: 650, vs: 0, arrivals: "low", date: "2026-08-25", fresh: false },
  { mandi: "indore", crop: "tamatar", min: 400, modal: 1000, max: 1600, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "tamatar", min: 1100, modal: 1400, max: 1600, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jaipur", crop: "tamatar", min: 4400, modal: 4500, max: 4600, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "tamatar", min: 1425, modal: 1945, max: 2465, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "lahsun", min: 2000, modal: 6500, max: 23301, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "lahsun", min: 3500, modal: 12750, max: 24400, vs: 0, arrivals: "high", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "lahsun", min: 13000, modal: 13000, max: 13000, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  ...
  { mandi: "jodhpur", crop: "moong", min: 5000, modal: 6250, max: 7500, vs: 0, arrivals: "low", date: "2026-08-25", fresh: false },
  { mandi: "nagaur", crop: "moong", min: 7050, modal: 7380, max: 7620, vs: 35, arrivals: "high", date: "2026-08-22", fresh: false },
  { mandi: "merta", crop: "moong", min: 5300, modal: 7100, max: 8500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "kota", crop: "til", min: 9000, modal: 9000, max: 9000, vs: 0, arrivals: "low", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "arhar", min: 5875, modal: 6050, max: 6050, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "gondal", crop: "tamatar", min: 1000, modal: 1750, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "gwar", min: 1000, modal: 3500, max: 6000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "aalu", min: 750, modal: 1000, max: 1250, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "pyaz", min: 1000, modal: 1900, max: 2800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "tamatar", min: 1000, modal: 2000, max: 3000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "kapas", min: 7500, modal: 9100, max: 9675, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "moongphali", min: 5000, modal: 6250, max: 7000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "gehun", min: 2400, modal: 2600, max: 2720, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "lahsun", min: 5000, modal: 9000, max: 13000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "aalu", min: 500, modal: 700, max: 900, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jaipur", crop: "pyaz", min: 4600, modal: 4800, max: 5000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jaipur", crop: "lahsun", min: 6000, modal: 11250, max: 17000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "rajkot", crop: "sarson", min: 6350, modal: 7200, max: 7610, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "lahsun", min: 5600, modal: 7875, max: 12700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "gehun", min: 2400, modal: 2688, max: 3110, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "pyaz", min: 1755, modal: 3000, max: 3805, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "aalu", min: 385, modal: 905, max: 1430, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "amreli", crop: "gehun", min: 2300, modal: 2688, max: 2925, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "deesa", crop: "lahsun", min: 8000, modal: 13000, max: 18000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "deesa", crop: "gwar", min: 5705, modal: 5925, max: 6025, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "deesa", crop: "pyaz", min: 3000, modal: 3500, max: 4000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "deesa", crop: "tamatar", min: 1500, modal: 1800, max: 2100, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "deesa", crop: "gehun", min: 2595, modal: 2650, max: 2720, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "deesa", crop: "sarson", min: 7450, modal: 7550, max: 7575, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "lahsun", min: 4500, modal: 7125, max: 7125, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ujjain", crop: "lahsun", min: 1000, modal: 6500, max: 15400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ujjain", crop: "aalu", min: 227, modal: 798, max: 844, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "ujjain", crop: "pyaz", min: 310, modal: 3664, max: 3700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ujjain", crop: "tamatar", min: 640, modal: 1392, max: 2140, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "makka", min: 1151, modal: 1799, max: 2400, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "neemuch", crop: "gehun", min: 2580, modal: 2900, max: 3190, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "gehun", min: 2112, modal: 2651, max: 2691, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "sarson", min: 2300, modal: 7500, max: 7500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "pyaz", min: 1800, modal: 2500, max: 3000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "aalu", min: 1200, modal: 1300, max: 1400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "tamatar", min: 2000, modal: 2200, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "gehun", min: 2300, modal: 2686, max: 2966, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "moongphali", min: 5060, modal: 7326, max: 7501, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "makka", min: 2000, modal: 2381, max: 2430, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "sarson", min: 5301, modal: 7471, max: 7471, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "pyaz", min: 2982, modal: 3555, max: 3555, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "aalu", min: 700, modal: 980, max: 1160, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "tamatar", min: 1000, modal: 1900, max: 2750, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "aalu", min: 600, modal: 650, max: 700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "gehun", min: 2500, modal: 2711, max: 2818, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "lahsun", min: 6600, modal: 12000, max: 22000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "tamatar", min: 1300, modal: 1500, max: 1700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "makka", min: 2180, modal: 2300, max: 2800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jaipur", crop: "sarson", min: 8000, modal: 8000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jalore", crop: "tamatar", min: 1800, modal: 1900, max: 2000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "unjha", crop: "sarson", min: 7375, modal: 7375, max: 7375, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mehsana", crop: "aalu", min: 500, modal: 1000, max: 1400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mehsana", crop: "pyaz", min: 1500, modal: 3750, max: 5000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mehsana", crop: "tamatar", min: 50, modal: 60, max: 70, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mehsana", crop: "sarson", min: 7000, modal: 7450, max: 7475, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mehsana", crop: "gehun", min: 2450, modal: 2600, max: 2685, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "patan", crop: "tamatar", min: 1000, modal: 1100, max: 1200, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "gondal", crop: "makka", min: 1505, modal: 2705, max: 3005, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "neemuch", crop: "pyaz", min: 2191, modal: 3640, max: 3640, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "moongphali", min: 6851, modal: 7450, max: 7450, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ratlam", crop: "pyaz", min: 200, modal: 2780, max: 4001, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ratlam", crop: "gehun", min: 2500, modal: 2811, max: 3057, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ratlam", crop: "lahsun", min: 2000, modal: 6100, max: 19000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "ramganj", crop: "aalu", min: 550, modal: 1150, max: 1200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "pyaz", min: 1300, modal: 4300, max: 4400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "tamatar", min: 1000, modal: 1100, max: 1200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "gehun", min: 2200, modal: 2425, max: 2531, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "makka", min: 2100, modal: 2100, max: 2100, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "beawar", crop: "makka", min: 2500, modal: 2500, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "nimbahera", crop: "sarson", min: 6961, modal: 7316, max: 7670, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "nimbahera", crop: "gehun", min: 2650, modal: 2826, max: 3002, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "nimbahera", crop: "moongphali", min: 6700, modal: 7100, max: 7500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "nimbahera", crop: "lahsun", min: 5500, modal: 17200, max: 23800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "hisar", crop: "lahsun", min: 18000, modal: 19000, max: 20000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "hisar", crop: "aalu", min: 900, modal: 950, max: 1000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "hisar", crop: "tamatar", min: 2000, modal: 2250, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "hisar", crop: "pyaz", min: 3500, modal: 4000, max: 4200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "fatehabad", crop: "aalu", min: 500, modal: 600, max: 700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "fatehabad", crop: "tamatar", min: 1800, modal: 1800, max: 1800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "fatehabad", crop: "pyaz", min: 3500, modal: 3500, max: 3500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jind", crop: "aalu", min: 700, modal: 1000, max: 1100, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "jind", crop: "pyaz", min: 1500, modal: 2500, max: 4000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jind", crop: "tamatar", min: 1500, modal: 2200, max: 2500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "sirsa", crop: "pyaz", min: 2800, modal: 3300, max: 4000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sirsa", crop: "aalu", min: 350, modal: 500, max: 800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sirsa", crop: "tamatar", min: 1500, modal: 2108, max: 3000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "tarori", crop: "aalu", min: 1000, modal: 1200, max: 1500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "tarori", crop: "pyaz", min: 3000, modal: 3500, max: 4000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "panipat", crop: "pyaz", min: 1000, modal: 2500, max: 4000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "panipat", crop: "tamatar", min: 600, modal: 1100, max: 1600, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "panipat", crop: "aalu", min: 700, modal: 900, max: 1100, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sonepat", crop: "tamatar", min: 1500, modal: 2000, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sonepat", crop: "pyaz", min: 3500, modal: 4000, max: 4000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sonepat", crop: "aalu", min: 800, modal: 900, max: 1100, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "tamatar", min: 2500, modal: 2800, max: 3000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "lahsun", min: 12000, modal: 14000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "aalu", min: 1000, modal: 1200, max: 1500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "pyaz", min: 4000, modal: 4200, max: 4500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rohtak", crop: "aalu", min: 600, modal: 800, max: 1000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rohtak", crop: "pyaz", min: 1200, modal: 1500, max: 2000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "lahsun", min: 3025, modal: 7900, max: 8700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "pyaz", min: 2500, modal: 3500, max: 4400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "tamatar", min: 1000, modal: 1600, max: 2000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "gehun", min: 2450, modal: 2450, max: 2450, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "shahabad", crop: "makka", min: 2100, modal: 2100, max: 2100, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "aalu", min: 500, modal: 575, max: 800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "sri-ganganagar", crop: "chana", min: 5700, modal: 5710, max: 7550, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "baran", crop: "moong", min: 6936, modal: 6936, max: 6936, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "chana", min: 5072, modal: 5481, max: 5500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "urad", min: 6000, modal: 6645, max: 7191, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "dhan", min: 3500, modal: 3700, max: 3986, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "dhaniya", min: 13351, modal: 14260, max: 14800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "baran", crop: "alsi", min: 9000, modal: 9000, max: 9000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "jalore", crop: "adrak", min: 4500, modal: 4600, max: 4700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jalore", crop: "hara-dhaniya", min: 2500, modal: 2800, max: 3000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "jaipur", crop: "jau", min: 2500, modal: 2553, max: 2606, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jaipur", crop: "hara-dhaniya", min: 1000, modal: 6500, max: 11000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "jaipur", crop: "kela", min: 2000, modal: 2900, max: 3500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "jaipur", crop: "adrak", min: 5500, modal: 8600, max: 14500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "jaipur", crop: "amrood", min: 3000, modal: 5750, max: 8500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "jaipur", crop: "seb", min: 5000, modal: 9250, max: 15000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "jaipur", crop: "anar", min: 4000, modal: 8000, max: 12000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "jodhpur", crop: "chana", min: 5500, modal: 5875, max: 7350, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "adrak", min: 5000, modal: 6000, max: 7500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "til", min: 9000, modal: 11625, max: 16950, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "dhaniya", min: 14800, modal: 15000, max: 15250, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "seb", min: 5000, modal: 7500, max: 12000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "amrood", min: 1000, modal: 1700, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "anar", min: 4000, modal: 6000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "arandi", min: 7000, modal: 7075, max: 7150, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "nimbahera", crop: "jau", min: 2400, modal: 2580, max: 2760, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "unjha", crop: "til", min: 11500, modal: 11850, max: 11950, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "unjha", crop: "saunf", min: 7005, modal: 9850, max: 24500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mehsana", crop: "kela", min: 1500, modal: 1900, max: 2300, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mehsana", crop: "bajra", min: 2200, modal: 2325, max: 2495, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mehsana", crop: "arandi", min: 7000, modal: 7158, max: 7250, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "deesa", crop: "hara-dhaniya", min: 1000, modal: 1750, max: 2500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "deesa", crop: "kela", min: 3000, modal: 3750, max: 4500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "deesa", crop: "anar", min: 6000, modal: 8000, max: 10000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "deesa", crop: "adrak", min: 5500, modal: 6250, max: 7000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "deesa", crop: "arandi", min: 7185, modal: 7210, max: 7225, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "deesa", crop: "seb", min: 7000, modal: 9500, max: 12000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "gondal", crop: "seb", min: 13000, modal: 14000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "kela", min: 1500, modal: 2175, max: 2850, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "anar", min: 3500, modal: 6750, max: 10000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "amrood", min: 7000, modal: 7500, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "jowar", min: 4755, modal: 5755, max: 6405, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "bajra", min: 1605, modal: 2055, max: 2255, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "arandi", min: 6655, modal: 7055, max: 7155, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "moong", min: 3100, modal: 6965, max: 6965, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "indore", crop: "hara-matar", min: 2560, modal: 3800, max: 3800, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "indore", crop: "kela", min: 600, modal: 800, max: 1200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "hara-dhaniya", min: 300, modal: 500, max: 700, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "indore", crop: "seb", min: 4000, modal: 8000, max: 12000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "anar", min: 3000, modal: 6000, max: 9000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ujjain", crop: "adrak", min: 535, modal: 1352, max: 2430, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ujjain", crop: "hara-dhaniya", min: 550, modal: 1264, max: 2240, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ujjain", crop: "seb", min: 2333, modal: 6034, max: 9000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "chana", min: 2501, modal: 6751, max: 7561, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "arhar", min: 6980, modal: 6980, max: 6980, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "harda", crop: "hara-matar", min: 2000, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "harda", crop: "urad", min: 5099, modal: 5099, max: 5099, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "harda", crop: "moong", min: 1001, modal: 7000, max: 7521, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "anar", min: 8000, modal: 9000, max: 10000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "seb", min: 8000, modal: 9000, max: 10000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "hara-dhaniya", min: 600, modal: 700, max: 1000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "hara-dhaniya", min: 13900, modal: 13900, max: 15050, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "chana", min: 2100, modal: 5800, max: 7900, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "isabgol", min: 4509, modal: 13400, max: 13400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "masoor", min: 5601, modal: 7000, max: 7000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "moong", min: 6666, modal: 6666, max: 6666, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "jau", min: 2361, modal: 2801, max: 2801, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "neemuch", crop: "til", min: 7000, modal: 10500, max: 10500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "alsi", min: 8500, modal: 9268, max: 9268, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "urad", min: 3301, modal: 7800, max: 7800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ratlam", crop: "chana", min: 5690, modal: 6690, max: 7601, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ratlam", crop: "hara-matar", min: 2431, modal: 3981, max: 3981, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "sirsa", crop: "kela", min: 2500, modal: 2500, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sirsa", crop: "seb", min: 5000, modal: 10000, max: 12000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sirsa", crop: "amrood", min: 1400, modal: 2500, max: 3500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "hisar", crop: "amrood", min: 2000, modal: 2500, max: 3000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "hisar", crop: "adrak", min: 14000, modal: 14500, max: 15000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "hisar", crop: "seb", min: 5000, modal: 12500, max: 15000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "ramganj", crop: "hara-matar", min: 3300, modal: 3300, max: 3400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "dhan", min: 1800, modal: 2200, max: 2400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "kela", min: 600, modal: 712, max: 1000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rohtak", crop: "seb", min: 8000, modal: 10000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rohtak", crop: "kela", min: 1800, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rohtak", crop: "amrood", min: 2500, modal: 3500, max: 5000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "adrak", min: 7000, modal: 7500, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "hara-matar", min: 8000, modal: 8500, max: 9000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "anar", min: 7000, modal: 8000, max: 8775, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "seb", min: 3000, modal: 6000, max: 9535, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "dhan", min: 1605, modal: 1606, max: 1608, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "patan", crop: "adrak", min: 1500, modal: 2000, max: 2500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "patan", crop: "hara-dhaniya", min: 8, modal: 9, max: 10, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "tarori", crop: "kela", min: 1800, modal: 2000, max: 2200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "panipat", crop: "kela", min: 2000, modal: 2600, max: 3200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "panipat", crop: "amrood", min: 2000, modal: 2500, max: 3000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "panipat", crop: "seb", min: 4000, modal: 8000, max: 12000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "panipat", crop: "anar", min: 5000, modal: 7000, max: 9000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sonepat", crop: "seb", min: 4000, modal: 8000, max: 10000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sonepat", crop: "amrood", min: 3500, modal: 4000, max: 4200, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "sonepat", crop: "kela", min: 3500, modal: 4000, max: 4000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sonepat", crop: "anar", min: 4000, modal: 8000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "hara-dhaniya", min: 5000, modal: 5500, max: 6000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "adrak", min: 10000, modal: 12000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "seb", min: 12000, modal: 14000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "amrood", min: 2500, modal: 2800, max: 3000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "til", min: 7003, modal: 9476, max: 10580, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "hara-dhaniya", min: 12490, modal: 14700, max: 14700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "masoor", min: 4400, modal: 8000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "urad", min: 5164, modal: 5164, max: 5164, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "alsi", min: 8501, modal: 9100, max: 9283, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "chana", min: 4400, modal: 6646, max: 7391, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "hara-matar", min: 2601, modal: 3019, max: 3054, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "moong", min: 6100, modal: 6100, max: 6100, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "isabgol", min: 4000, modal: 12001, max: 12001, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "fatehabad", crop: "amrood", min: 2000, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "fatehabad", crop: "seb", min: 8000, modal: 8000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "fatehabad", crop: "kela", min: 2000, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "fatehabad", crop: "anar", min: 8000, modal: 8000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "jowar", min: 2250, modal: 4388, max: 6550, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "til", min: 10240, modal: 11730, max: 12100, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "chana", min: 5025, modal: 7315, max: 9000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "dhaniya", min: 13650, modal: 14812, max: 15500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "bajra", min: 1850, modal: 2255, max: 2760, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "arandi", min: 6720, modal: 7050, max: 7140, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "urad", min: 6000, modal: 9115, max: 9355, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "arhar", min: 6400, modal: 7250, max: 8255, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "moong", min: 5200, modal: 7250, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "jeera", min: 17750, modal: 19075, max: 20075, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "hara-dhaniya", min: 555, modal: 795, max: 1035, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "adrak", min: 6115, modal: 10625, max: 15140, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "matar", min: 8000, modal: 8300, max: 8500, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "mandsaur", crop: "jau", min: 2301, modal: 2801, max: 2801, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  ...
  { mandi: "baran", crop: "methi", min: 6060, modal: 6060, max: 6060, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "nimbahera", crop: "methi", min: 6300, modal: 7275, max: 7952, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "amreli", crop: "methi", min: 6000, modal: 6575, max: 7025, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "rajkot", crop: "methi", min: 4650, modal: 7300, max: 9450, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "indore", crop: "hari-methi", min: 800, modal: 1800, max: 3000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "methi", min: 4700, modal: 6326, max: 7050, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "methi", min: 900, modal: 5899, max: 7153, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  ...
  { mandi: "kota", crop: "seb", min: 11000, modal: 11000, max: 11000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "anar", min: 10000, modal: 10000, max: 10000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "kela", min: 2000, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "goluwala", crop: "gwar", min: 5800, modal: 5900, max: 5925, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  ...
  { mandi: "goluwala", crop: "sarson", min: 6501, modal: 7400, max: 7530, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "goluwala", crop: "aalu", min: 500, modal: 700, max: 700, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "goluwala", crop: "gehun", min: 2550, modal: 2560, max: 2575, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "goluwala", crop: "chana", min: 5401, modal: 5701, max: 5701, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "ramganj", crop: "dhaniya", min: 13500, modal: 14301, max: 15101, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "masoor", min: 6000, modal: 6950, max: 7900, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "chana", min: 5301, modal: 5521, max: 5740, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "sarson", min: 7092, modal: 7221, max: 7350, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "mandsaur", crop: "asaliya", min: 6150, modal: 6175, max: 6200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "sarson", min: 7100, modal: 7512, max: 7512, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "neemuch", crop: "kalonji", min: 15000, modal: 18375, max: 18700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sirsa", crop: "gehun", min: 2500, modal: 2500, max: 2500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "adampur", crop: "aalu", min: 500, modal: 600, max: 600, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "adampur", crop: "pyaz", min: 3800, modal: 4000, max: 4000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "adampur", crop: "tamatar", min: 2000, modal: 2500, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "adampur", crop: "adrak", min: 7000, modal: 8000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "adampur", crop: "lahsun", min: 12000, modal: 14000, max: 14000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "adampur", crop: "hara-matar", min: 7000, modal: 8000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "kela", min: 2800, modal: 3500, max: 3925, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "ganaur", crop: "kela", min: 3000, modal: 3500, max: 4000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "rohtak", crop: "anar", min: 8000, modal: 10000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "rohtak", crop: "tamatar", min: 1500, modal: 2500, max: 3500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "methi", min: 5800, modal: 5800, max: 5800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "dhaniya", min: 13000, modal: 13000, max: 13000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "alsi", min: 9000, modal: 9000, max: 9000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "urad", min: 7300, modal: 7300, max: 7300, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "moong", min: 7250, modal: 7250, max: 7250, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "kota", crop: "bajra", min: 1952, modal: 1952, max: 1952, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "kota", crop: "jau", min: 2650, modal: 2650, max: 2650, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "indore", crop: "urad", min: 7000, modal: 7000, max: 7000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "fatehabad", crop: "moong", min: 6750, modal: 6750, max: 6750, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ganaur", crop: "hara-matar", min: 10000, modal: 12000, max: 12000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "tarori", crop: "tamatar", min: 3000, modal: 3500, max: 4000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "ramganj", crop: "hari-mirch", min: 500, modal: 2500, max: 6000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "jalore", crop: "hari-mirch", min: 1500, modal: 1600, max: 1800, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "mehsana", crop: "hari-mirch", min: 1000, modal: 1750, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "hari-mirch", min: 1000, modal: 2500, max: 4000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "rajkot", crop: "hari-mirch", min: 1690, modal: 2225, max: 2760, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "deesa", crop: "hari-mirch", min: 2000, modal: 2500, max: 3000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "indore", crop: "hari-mirch", min: 1500, modal: 2500, max: 3500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "mandsaur", crop: "hari-mirch", min: 3250, modal: 3825, max: 4475, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "adampur", crop: "hari-mirch", min: 1500, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "hari-mirch", min: 2500, modal: 3000, max: 3200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "hari-mirch", min: 4000, modal: 4500, max: 5000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ujjain", crop: "hari-mirch", min: 580, modal: 1339, max: 2380, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sri-ganganagar", crop: "hari-mirch", min: 3050, modal: 3050, max: 3050, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "goluwala", crop: "jau", min: 2301, modal: 2301, max: 2301, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "ramganj", crop: "arhar", min: 5500, modal: 5500, max: 5500, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "beawar", crop: "sarson", min: 7250, modal: 7250, max: 7250, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "tamatar", min: 2200, modal: 2200, max: 2200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "anar", min: 8500, modal: 8500, max: 8500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "adrak", min: 4800, modal: 4800, max: 4800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "seb", min: 5000, modal: 5000, max: 5000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "amrood", min: 2800, modal: 2800, max: 2800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "pyaz", min: 2000, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "hari-mirch", min: 2100, modal: 2100, max: 2100, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "hara-dhaniya", min: 3400, modal: 3400, max: 3400, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "bikaner", crop: "aalu", min: 1000, modal: 1000, max: 1000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "hari-mirch", min: 1600, modal: 2500, max: 3200, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "jodhpur", crop: "kela", min: 1000, modal: 1500, max: 2000, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "jaipur", crop: "hari-mirch", min: 2000, modal: 3375, max: 4000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "patan", crop: "hari-mirch", min: 2000, modal: 2750, max: 3500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "bikaner", crop: "kela", min: 2800, modal: 2800, max: 2800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "jaipur", crop: "hara-matar", min: 11000, modal: 11000, max: 11000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  ...
  { mandi: "harda", crop: "hari-mirch", min: 2000, modal: 2200, max: 2500, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "fatehabad", crop: "makka", min: 2000, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  { mandi: "tarori", crop: "seb", min: 5000, modal: 5500, max: 6000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "mandsaur", crop: "haldi", min: 14285, modal: 14285, max: 14285, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  ...
  { mandi: "fatehabad", crop: "gehun", min: 2450, modal: 2452, max: 2460, vs: 0, arrivals: "med", date: "2026-08-25", fresh: false },
  ...
  { mandi: "kota", crop: "arandi", min: 5752, modal: 5752, max: 5752, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "rice", min: 1950, modal: 1950, max: 1950, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ramganj", crop: "alsi", min: 7601, modal: 8201, max: 8800, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "beawar", crop: "moongphali", min: 6250, modal: 6250, max: 6250, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "merta", crop: "saunf", min: 7500, modal: 9500, max: 11000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "merta", crop: "sarson", min: 7500, modal: 7600, max: 7700, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "merta", crop: "chana", min: 4900, modal: 5600, max: 5900, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "patan", crop: "jowar", min: 4400, modal: 4700, max: 5000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "patan", crop: "arandi", min: 7000, modal: 7125, max: 7230, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "patan", crop: "sarson", min: 7255, modal: 7500, max: 7665, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "patan", crop: "saunf", min: 7500, modal: 8500, max: 9005, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "patan", crop: "bajra", min: 2200, modal: 2460, max: 2460, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "patan", crop: "gehun", min: 2525, modal: 2700, max: 2830, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "moong", min: 4005, modal: 6705, max: 7755, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "urad", min: 4505, modal: 7755, max: 9205, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "methi", min: 6055, modal: 6905, max: 7555, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "arhar", min: 5000, modal: 7255, max: 8305, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "jeera", min: 12755, modal: 19105, max: 19905, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "gondal", crop: "dhaniya", min: 12005, modal: 15355, max: 15555, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "sirsa", crop: "hari-mirch", min: 2000, modal: 2502, max: 2530, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "hisar", crop: "sarson", min: 8182, modal: 8200, max: 8211, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "hisar", crop: "kapas", min: 7125, modal: 7500, max: 7926, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "shahabad", crop: "rice", min: 1950, modal: 1950, max: 1950, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "ganaur", crop: "anar", min: 10000, modal: 12000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
  { mandi: "harda", crop: "kela", min: 600, modal: 600, max: 600, vs: 0, arrivals: "med", date: "2026-08-27", fresh: true },
];
