...
MB.prices = [
  { mandi: "agra", crop: "hari-mirch", min: 1600, modal: 1600, max: 1600, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "agra", crop: "aalu", min: 500, modal: 604, max: 1100, vs: 0, arrivals: "high", date: "2026-09-26", fresh: true },
  ...
  { mandi: "indore", crop: "chana", min: 6000, modal: 8600, max: 8600, vs: 0, arrivals: "high", date: "2026-09-26", fresh: true },
  ...
  { mandi: "indore", crop: "soyabean", min: 500, modal: 5100, max: 5750, vs: 0, arrivals: "high", date: "2026-09-24", fresh: true },
  { mandi: "ujjain", crop: "soyabean", min: 4600, modal: 4600, max: 4600, vs: 0, arrivals: "high", date: "2026-09-26", fresh: true },
  ...
  { mandi: "indore", crop: "arhar", min: 6900, modal: 6900, max: 6900, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "ratlam", crop: "pyaz", min: 2700, modal: 2700, max: 2700, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "bareilly", crop: "hari-mirch", min: 2000, modal: 3794, max: 4000, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "gorakhpur", crop: "gehun", min: 2740, modal: 2740, max: 2740, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "hathras", crop: "moong", min: 6276, modal: 6276, max: 6276, vs: 0, arrivals: "med", date: "2026-09-24", fresh: true },
  { mandi: "hathras", crop: "aalu", min: 500, modal: 595, max: 1100, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "kanpur", crop: "lahsun", min: 7000, modal: 7000, max: 7000, vs: 0, arrivals: "med", date: "2026-09-24", fresh: true },
  { mandi: "kanpur", crop: "hari-mirch", min: 3000, modal: 3000, max: 3000, vs: 0, arrivals: "med", date: "2026-09-25", fresh: true },
  ...
  { mandi: "mathura", crop: "aalu", min: 600, modal: 693, max: 700, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "mathura", crop: "tamatar", min: 1900, modal: 2382, max: 2800, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "saharanpur", crop: "moongphali", min: 7500, modal: 7500, max: 7500, vs: 0, arrivals: "med", date: "2026-09-12", fresh: true },
  { mandi: "saharanpur", crop: "pyaz", min: 3500, modal: 3500, max: 3500, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "bareilly", crop: "dhan", min: 2000, modal: 2069, max: 2411, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "gorakhpur", crop: "hari-mirch", min: 4940, modal: 4940, max: 4940, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  ...
  { mandi: "gorakhpur", crop: "tamatar", min: 2500, modal: 2500, max: 2500, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "hathras", crop: "bajra", min: 1955, modal: 2077, max: 2139, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "hapur", crop: "dhan", min: 2901, modal: 3266, max: 3840, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "lucknow", crop: "aalu", min: 800, modal: 800, max: 800, vs: 0, arrivals: "med", date: "2026-09-24", fresh: true },
  ...
  { mandi: "mathura", crop: "hari-mirch", min: 3200, modal: 3400, max: 3500, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "mathura", crop: "gehun", min: 2525, modal: 2525, max: 2525, vs: 0, arrivals: "med", date: "2026-09-25", fresh: true },
  { mandi: "meerut", crop: "aalu", min: 800, modal: 887, max: 1000, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  ...
  { mandi: "muzaffarnagar", crop: "adrak", min: 10000, modal: 10000, max: 10000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "muzaffarnagar", crop: "hari-mirch", min: 2500, modal: 2500, max: 2500, vs: 0, arrivals: "med", date: "2026-09-24", fresh: true },
  { mandi: "muzaffarnagar", crop: "aalu", min: 800, modal: 862, max: 1000, vs: 0, arrivals: "med", date: "2026-09-25", fresh: true },
  { mandi: "muzaffarnagar", crop: "til", min: 6100, modal: 6100, max: 6100, vs: 0, arrivals: "med", date: "2026-09-19", fresh: true },
  { mandi: "saharanpur", crop: "chana", min: 8750, modal: 8750, max: 8750, vs: 0, arrivals: "med", date: "2026-08-29", fresh: true },
  { mandi: "saharanpur", crop: "dhan", min: 3089, modal: 3500, max: 3762, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "saharanpur", crop: "haldi", min: 12000, modal: 12000, max: 12000, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  ...
  { mandi: "gorakhpur", crop: "moong", min: 9000, modal: 9000, max: 9000, vs: 0, arrivals: "med", date: "2026-09-06", fresh: true },
  { mandi: "gorakhpur", crop: "rice", min: 2400, modal: 2400, max: 2400, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "hathras", crop: "kapas", min: 7000, modal: 7365, max: 8600, vs: 0, arrivals: "med", date: "2026-09-25", fresh: true },
  { mandi: "hapur", crop: "rice", min: 3500, modal: 3652, max: 3794, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "kanpur", crop: "alsi", min: 11388, modal: 11388, max: 11388, vs: 0, arrivals: "med", date: "2026-09-16", fresh: true },
  { mandi: "kanpur", crop: "makka", min: 1700, modal: 1700, max: 1700, vs: 0, arrivals: "med", date: "2026-09-24", fresh: true },
  { mandi: "lucknow", crop: "lahsun", min: 18852, modal: 18852, max: 18852, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "lucknow", crop: "jowar", min: 3650, modal: 3650, max: 3650, vs: 0, arrivals: "med", date: "2026-09-14", fresh: true },
  { mandi: "lucknow", crop: "sarson", min: 8650, modal: 8650, max: 8650, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "lucknow", crop: "soyabean", min: 7500, modal: 7500, max: 7500, vs: 0, arrivals: "med", date: "2026-09-15", fresh: true },
  ...
  { mandi: "meerut", crop: "hara-dhaniya", min: 13246, modal: 13246, max: 13246, vs: 0, arrivals: "med", date: "2026-08-30", fresh: true },
  { mandi: "saharanpur", crop: "mirch", min: 10710, modal: 10710, max: 10710, vs: 0, arrivals: "med", date: "2026-09-14", fresh: true },
  { mandi: "saharanpur", crop: "hara-dhaniya", min: 7000, modal: 7000, max: 7000, vs: 0, arrivals: "med", date: "2026-09-25", fresh: true },
  { mandi: "saharanpur", crop: "makka", min: 6200, modal: 6200, max: 6200, vs: 0, arrivals: "med", date: "2026-08-30", fresh: true },
  { mandi: "saharanpur", crop: "saunf", min: 9000, modal: 9000, max: 9000, vs: 0, arrivals: "med", date: "2026-08-30", fresh: true },
  { mandi: "saharanpur", crop: "tamatar", min: 1500, modal: 1702, max: 1800, vs: 0, arrivals: "med", date: "2026-09-25", fresh: true },
  { mandi: "aligarh", crop: "adrak", min: 6000, modal: 6000, max: 6000, vs: 0, arrivals: "med", date: "2026-09-14", fresh: true },
  ...
  { mandi: "bareilly", crop: "haldi", min: 10700, modal: 10700, max: 10700, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "gorakhpur", crop: "moongphali", min: 4800, modal: 8558, max: 10130, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "gorakhpur", crop: "jowar", min: 2835, modal: 2835, max: 2835, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "gorakhpur", crop: "sarson", min: 5550, modal: 6078, max: 6371, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "gorakhpur", crop: "til", min: 12493, modal: 12493, max: 12493, vs: 0, arrivals: "med", date: "2026-09-05", fresh: true },
  { mandi: "hapur", crop: "sarson", min: 12000, modal: 12000, max: 12000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  ...
  { mandi: "lucknow", crop: "jau", min: 2857, modal: 2857, max: 2857, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  ...
  { mandi: "mathura", crop: "bajra", min: 2050, modal: 2086, max: 2140, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "mathura", crop: "mirch", min: 35000, modal: 35000, max: 35000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "mathura", crop: "hara-dhaniya", min: 20000, modal: 20000, max: 20000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "mathura", crop: "moongphali", min: 11000, modal: 11067, max: 12000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "mathura", crop: "methi", min: 15000, modal: 15000, max: 15000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "mathura", crop: "saunf", min: 20000, modal: 20000, max: 20000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "mathura", crop: "haldi", min: 18000, modal: 18032, max: 18095, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "meerut", crop: "bajra", min: 2680, modal: 2712, max: 2750, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "meerut", crop: "jau", min: 2450, modal: 2593, max: 2750, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "meerut", crop: "lahsun", min: 10000, modal: 10000, max: 10000, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "meerut", crop: "adrak", min: 9514, modal: 9514, max: 9514, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "meerut", crop: "hari-mirch", min: 4000, modal: 4000, max: 4000, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  { mandi: "meerut", crop: "jowar", min: 4200, modal: 4200, max: 4200, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "meerut", crop: "makka", min: 2560, modal: 2699, max: 2750, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "meerut", crop: "pyaz", min: 4196, modal: 4196, max: 4196, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "meerut", crop: "dhan", min: 3000, modal: 3000, max: 3000, vs: 0, arrivals: "med", date: "2026-08-31", fresh: true },
  { mandi: "meerut", crop: "tamatar", min: 2000, modal: 2085, max: 3000, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  { mandi: "muzaffarnagar", crop: "jau", min: 2135, modal: 2143, max: 2150, vs: 0, arrivals: "med", date: "2026-09-24", fresh: true },
  { mandi: "muzaffarnagar", crop: "lahsun", min: 21078, modal: 21078, max: 21078, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  ...
  { mandi: "saharanpur", crop: "jau", min: 2855, modal: 2855, max: 2855, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  { mandi: "agra", crop: "hara-matar", min: 4701, modal: 4701, max: 4701, vs: 0, arrivals: "med", date: "2026-09-01", fresh: true },
  { mandi: "aligarh", crop: "jau", min: 2760, modal: 2760, max: 2760, vs: 0, arrivals: "med", date: "2026-09-01", fresh: true },
  { mandi: "aligarh", crop: "arhar", min: 7000, modal: 7000, max: 7000, vs: 0, arrivals: "med", date: "2026-09-01", fresh: true },
  { mandi: "aligarh", crop: "rice", min: 5234, modal: 5234, max: 5234, vs: 0, arrivals: "med", date: "2026-09-19", fresh: true },
  { mandi: "bareilly", crop: "mirch", min: 9000, modal: 16901, max: 22861, vs: 0, arrivals: "med", date: "2026-09-25", fresh: true },
  { mandi: "gorakhpur", crop: "aalu", min: 1500, modal: 1500, max: 1500, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "hathras", crop: "sarson", min: 7350, modal: 7350, max: 7350, vs: 0, arrivals: "med", date: "2026-09-08", fresh: true },
  { mandi: "kanpur", crop: "adrak", min: 10000, modal: 10000, max: 10000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  ...
  { mandi: "kanpur", crop: "saunf", min: 9524, modal: 9524, max: 9524, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  { mandi: "kanpur", crop: "soyabean", min: 4000, modal: 4000, max: 4000, vs: 0, arrivals: "med", date: "2026-09-01", fresh: true },
  { mandi: "mathura", crop: "moong", min: 8768, modal: 8768, max: 8768, vs: 0, arrivals: "med", date: "2026-09-25", fresh: true },
  { mandi: "agra", crop: "arhar", min: 10618, modal: 10618, max: 10618, vs: 0, arrivals: "med", date: "2026-09-02", fresh: true },
  { mandi: "gorakhpur", crop: "hara-dhaniya", min: 14000, modal: 14000, max: 14000, vs: 0, arrivals: "med", date: "2026-09-25", fresh: true },
  { mandi: "gorakhpur", crop: "methi", min: 4274, modal: 4274, max: 4274, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  { mandi: "lucknow", crop: "til", min: 18300, modal: 20650, max: 23000, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  { mandi: "mainpuri", crop: "dhan", min: 3200, modal: 3200, max: 3200, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "gorakhpur", crop: "chana", min: 6800, modal: 7433, max: 8700, vs: 0, arrivals: "med", date: "2026-09-04", fresh: true },
  { mandi: "hathras", crop: "tamatar", min: 2000, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-09-24", fresh: true },
  { mandi: "lucknow", crop: "chana", min: 7400, modal: 7400, max: 7400, vs: 0, arrivals: "med", date: "2026-09-05", fresh: true },
  { mandi: "mainpuri", crop: "sarson", min: 7000, modal: 7000, max: 7000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "bareilly", crop: "jau", min: 2975, modal: 2975, max: 2975, vs: 0, arrivals: "med", date: "2026-09-15", fresh: true },
  { mandi: "hathras", crop: "dhan", min: 3201, modal: 3701, max: 4181, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  ...
  { mandi: "kanpur", crop: "arhar", min: 10649, modal: 10649, max: 10649, vs: 0, arrivals: "med", date: "2026-09-06", fresh: true },
  { mandi: "muzaffarnagar", crop: "rice", min: 3559, modal: 3559, max: 3559, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "mathura", crop: "dhan", min: 3000, modal: 3518, max: 3821, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "lucknow", crop: "makka", min: 2300, modal: 2300, max: 2300, vs: 0, arrivals: "med", date: "2026-09-19", fresh: true },
  ...
  { mandi: "bareilly", crop: "hara-matar", min: 6000, modal: 6000, max: 6000, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "gorakhpur", crop: "alsi", min: 6500, modal: 6500, max: 6500, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "hathras", crop: "lahsun", min: 8000, modal: 8000, max: 8000, vs: 0, arrivals: "med", date: "2026-09-24", fresh: true },
  { mandi: "hapur", crop: "adrak", min: 8745, modal: 8745, max: 8745, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "hapur", crop: "hari-mirch", min: 5050, modal: 5050, max: 5050, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "hapur", crop: "moong", min: 11825, modal: 11825, max: 11825, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "hapur", crop: "moongphali", min: 16397, modal: 16447, max: 23574, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "hapur", crop: "jowar", min: 3383, modal: 3383, max: 3383, vs: 0, arrivals: "med", date: "2026-09-13", fresh: true },
  { mandi: "hapur", crop: "pyaz", min: 3807, modal: 3807, max: 3807, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "hapur", crop: "hara-matar", min: 6084, modal: 6084, max: 6084, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "hapur", crop: "arhar", min: 14930, modal: 14930, max: 14930, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "hapur", crop: "saunf", min: 34338, modal: 34338, max: 34338, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "mathura", crop: "jowar", min: 4184, modal: 4184, max: 4184, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "mathura", crop: "soyabean", min: 11064, modal: 11064, max: 11064, vs: 0, arrivals: "med", date: "2026-09-11", fresh: true },
  { mandi: "muzaffarnagar", crop: "tamatar", min: 2000, modal: 2000, max: 2000, vs: 0, arrivals: "med", date: "2026-09-14", fresh: true },
  { mandi: "gorakhpur", crop: "bajra", min: 3000, modal: 3000, max: 3000, vs: 0, arrivals: "med", date: "2026-09-12", fresh: true },
  { mandi: "gorakhpur", crop: "makka", min: 2600, modal: 2600, max: 2600, vs: 0, arrivals: "med", date: "2026-09-12", fresh: true },
  { mandi: "lucknow", crop: "arhar", min: 6000, modal: 6000, max: 6000, vs: 0, arrivals: "med", date: "2026-09-12", fresh: true },
  ...
  { mandi: "saharanpur", crop: "methi", min: 4000, modal: 4000, max: 4000, vs: 0, arrivals: "med", date: "2026-09-12", fresh: true },
  { mandi: "agra", crop: "jowar", min: 4218, modal: 4218, max: 4218, vs: 0, arrivals: "med", date: "2026-09-13", fresh: true },
  { mandi: "agra", crop: "soyabean", min: 10754, modal: 10754, max: 10754, vs: 0, arrivals: "med", date: "2026-09-13", fresh: true },
  { mandi: "lucknow", crop: "saunf", min: 26000, modal: 28500, max: 31000, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  { mandi: "mathura", crop: "makka", min: 2090, modal: 2090, max: 2090, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "aligarh", crop: "sarson", min: 7400, modal: 7400, max: 7400, vs: 0, arrivals: "med", date: "2026-09-21", fresh: true },
  { mandi: "hathras", crop: "mirch", min: 9500, modal: 9500, max: 9500, vs: 0, arrivals: "med", date: "2026-09-15", fresh: true },
  { mandi: "lucknow", crop: "methi", min: 7070, modal: 7070, max: 7070, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "mathura", crop: "jau", min: 2880, modal: 2880, max: 2880, vs: 0, arrivals: "med", date: "2026-09-16", fresh: true },
  { mandi: "mathura", crop: "alsi", min: 4800, modal: 4800, max: 4800, vs: 0, arrivals: "med", date: "2026-09-15", fresh: true },
  { mandi: "mathura", crop: "arhar", min: 6000, modal: 6396, max: 6500, vs: 0, arrivals: "med", date: "2026-09-24", fresh: true },
  { mandi: "mathura", crop: "til", min: 10000, modal: 10000, max: 10000, vs: 0, arrivals: "med", date: "2026-09-15", fresh: true },
  { mandi: "hathras", crop: "arhar", min: 6500, modal: 6500, max: 6500, vs: 0, arrivals: "med", date: "2026-09-26", fresh: true },
  { mandi: "kanpur", crop: "methi", min: 8774, modal: 8774, max: 8774, vs: 0, arrivals: "med", date: "2026-09-16", fresh: true },
  { mandi: "mainpuri", crop: "bajra", min: 1900, modal: 1900, max: 1900, vs: 0, arrivals: "med", date: "2026-09-21", fresh: true },
  { mandi: "meerut", crop: "sarson", min: 6500, modal: 6500, max: 6500, vs: 0, arrivals: "med", date: "2026-09-16", fresh: true },
  { mandi: "bareilly", crop: "arhar", min: 7500, modal: 7500, max: 7500, vs: 0, arrivals: "med", date: "2026-09-23", fresh: true },
  { mandi: "gorakhpur", crop: "adrak", min: 7000, modal: 7000, max: 7000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "gorakhpur", crop: "haldi", min: 18316, modal: 18316, max: 18316, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "hapur", crop: "mirch", min: 32000, modal: 32000, max: 32000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "hapur", crop: "hara-dhaniya", min: 20000, modal: 20000, max: 20000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "hapur", crop: "lahsun", min: 12500, modal: 12500, max: 12500, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "hapur", crop: "alsi", min: 38000, modal: 38000, max: 38000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "hapur", crop: "methi", min: 7000, modal: 7000, max: 7000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "hapur", crop: "til", min: 16000, modal: 16000, max: 16000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "hapur", crop: "tamatar", min: 4000, modal: 4000, max: 4000, vs: 0, arrivals: "med", date: "2026-09-17", fresh: true },
  { mandi: "kanpur", crop: "moongphali", min: 9200, modal: 9200, max: 9200, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  { mandi: "lucknow", crop: "alsi", min: 11500, modal: 11500, max: 11500, vs: 0, arrivals: "med", date: "2026-09-18", fresh: true },
  { mandi: "muzaffarnagar", crop: "bajra", min: 2240, modal: 2240, max: 2240, vs: 0, arrivals: "med", date: "2026-09-22", fresh: true },
  { mandi: "saharanpur", crop: "kapas", min: 15900, modal: 15900, max: 15900, vs: 0, arrivals: "med", date: "2026-09-19", fresh: true },
...
MB.articleProfiles = {
  ...
  "kanpur": {
    ...
    "intro": "कानपुर (Grain) APMC के इस पेज पर गेहूं, धान, बाजरा, आलू और दूसरी उपलब्ध उपज के सत्यापित न्यूनतम, मॉडल और अधिकतम भाव दिखते हैं। केवल कानपुर Grain APMC से मेल खाने वाले प्रकाशित रिकॉर्ड लिए जाते हैं।",
    "quality": "अनाज में नमी, दाने की सफाई और किस्म तथा आलू-सब्जियों में आकार और छंटाई के कारण अलग lot की बोली बदल सकती है।",
    "market": "कानपुर में अनाज और ताजी उपज के रिकॉर्ड अलग तारीखों पर प्रकाशित हो सकते हैं, इसलिए प्रत्येक पंक्ति की freshness और इकाई देखकर तुलना करें।",
    "advice": ["Kanpur Grain APMC को जिले की दूसरी sub-markets से न मिलाएँ।", "धान और rice के रिकॉर्ड अलग फसल नामों में पढ़ें।", "सब्जी के प्रति किलो और अनाज के प्रति क्विंटल भाव की सही इकाई देखें।"]
  },
  "meerut": {
    "title": "मेरठ मंडी भाव आज: अनाज, तिलहन और सब्जी रेट",
    "intro": "मेरठ APMC के उपलब्ध प्रकाशित रिकॉर्ड में गेहूं, सरसों, आलू, प्याज और दूसरी उपज शामिल हो सकती है। यह पेज उन्हीं सत्यापित रिकॉर्ड की भाव-range दिखाता है।",
    "quality": "गेहूं और सरसों में नमी व सफाई, जबकि आलू-प्याज में आकार, ताजगी और छंटाई भाव को प्रभावित कर सकती है।",
    "market": "पश्चिमी उत्तर प्रदेश की मौसमी आवक और स्थानीय थोक मांग से मेरठ के अलग-अलग फसल भाव बदलते हैं; पुरानी और नई पंक्तियां अलग पहचानें।",
    "advice": ["Meerut APMC का भाव Mawana या Sardhana APMC का भाव न मानें।", "गेहूं और सरसों की तुलना समान grade में करें।", "खुदरा रेट को मंडी के थोक रिकॉर्ड से सीधे न मिलाएँ।"]
  },
  "aligarh": {
    "title": "अलीगढ़ मंडी भाव आज: धान, गेहूं और सरसों की जानकारी",
    "intro": "अलीगढ़ APMC के सत्यापित रिकॉर्ड से धान, गेहूं, सरसों, बाजरा, आलू और अन्य उपलब्ध फसलों के न्यूनतम, मॉडल व अधिकतम भाव इस पेज पर दिए जाते हैं।",
    "quality": "धान की किस्म, गेहूं की नमी-सफाई, सरसों में तेल-अंश और बाजरे के दाने की गुणवत्ता अलग बोली का कारण बन सकती है।",
    "market": "नई फसल की आवक, खरीदारों की मांग और भंडारण योग्य उपज की उपलब्धता अलीगढ़ मंडी की भाव-range बदल सकती है।",
    "advice": ["Aligarh APMC को Atrauli, Charra या Khair APMC से अलग रखें।", "धान की किस्म जाने बिना ऊंचे और सामान्य भाव की तुलना न करें।", "मॉडल भाव को सामान्य दिशा समझें, अंतिम सौदा नहीं।"]
  },
  "bareilly": {
    "title": "बरेली मंडी भाव आज: धान, गेहूं और उपलब्ध उपज के रेट",
    "intro": "बरेली APMC में प्रकाशित धान, गेहूं, आलू, मूंग, लहसुन और दूसरी उपलब्ध उपज के सत्यापित भाव इस पेज पर एक साथ देखे जा सकते हैं।",
    "quality": "धान-गेहूं में किस्म, नमी और टूटन तथा मूंग व लहसुन में सफाई, आकार और lot की एकरूपता भाव में फर्क ला सकती है।",
    "market": "रुहेलखंड क्षेत्र की मौसमी आवक के साथ अनाज और सब्जी रिकॉर्ड की तारीख अलग हो सकती है, इसलिए freshness संकेत जरूरी है।",
    "advice": ["Bareilly APMC को Baheri या Anwala APMC से न मिलाएँ।", "धान और rice की पंक्तियां अलग अर्थ में पढ़ें।", "एक ही फसल की समान तारीख और grade वाली range तुलना करें।"]
  },
  "lucknow": {
    "title": "लखनऊ मंडी भाव आज: सब्जी, धान और अनाज के रेट",
    "intro": "लखनऊ APMC के उपलब्ध रिकॉर्ड में आलू, टमाटर, प्याज, हरी मिर्च के साथ धान, गेहूं और अन्य उपज भी मिलती है। पेज केवल official Lucknow APMC mapping का डेटा दिखाता है।",
    "quality": "ताजी सब्जियों में आकार, ताजगी और छंटाई तेजी से भाव बदलती है; धान व गेहूं में किस्म, नमी और सफाई अधिक महत्वपूर्ण हैं।",
    "market": "शहर की थोक मांग और दैनिक सब्जी आवक के कारण लखनऊ में ताजी उपज का भाव अनाज की तुलना में ज्यादा तेजी से बदल सकता है।",
    "advice": ["Lucknow APMC को Banthara या Sitapur APMC का रिकॉर्ड न मानें।", "डबग्गा/स्थानीय नाम खोजते समय table में official Lucknow APMC mapping समझें।", "सब्जी का प्रति किलो रूपांतरण सही इकाई में देखें।"]
  },
  "mathura": {
    "title": "मथुरा मंडी भाव आज: बाजरा, धान, गेहूं और सरसों",
    "intro": "मथुरा APMC के बाजरा, धान, गेहूं, सरसों, आलू और दूसरी उपलब्ध फसलों के सत्यापित भाव इस पेज पर दिखाए जाते हैं।",
    "quality": "बाजरा व गेहूं में दाने की सफाई और नमी, धान में किस्म तथा सरसों में तेल-अंश और lot quality भाव बदल सकते हैं।",
    "market": "मथुरा क्षेत्र की अनाज-तिलहन आवक और ताजी उपज की दैनिक उपलब्धता अलग-अलग तारीखों पर रिकॉर्ड हो सकती है।",
    "advice": ["Mathura APMC को Kosikalan APMC से अलग रखें।", "धान की किस्म और सरसों का grade मिलाकर तुलना करें।", "सबसे ऊंचे भाव को हर lot का सामान्य रेट न मानें।"]
  },
  "hathras": {
    "title": "हाथरस मंडी भाव आज: अनाज, तिलहन और कपास रेट",
    "intro": "Official source में Haathras APMC नाम से मिलने वाले बाजरा, धान, गेहूं, सरसों, कपास, आलू और अन्य उपलब्ध रिकॉर्ड इस हाथरस पेज पर दिखते हैं।",
    "quality": "कपास में नमी और सफाई, धान-गेहूं में किस्म व दाने की गुणवत्ता तथा आलू में आकार-छंटाई अलग भाव का कारण बनते हैं।",
    "market": "फसल की मौसमी आवक और खरीदार मांग के अनुसार हाथरस APMC की अलग फसलों की नवीनतम रिकॉर्ड तारीख बदल सकती है।",
    "advice": ["Haathras APMC की official spelling को Hathras page से map किया गया है।", "Sikandraraau या Shadabad APMC के भाव इसमें न मिलाएँ।", "कपास और अनाज की इकाई व grade अलग-अलग पढ़ें।"]
  },
  "gorakhpur": {
    "title": "गोरखपुर मंडी भाव आज: पूर्वी उत्तर प्रदेश की फसलवार दरें",
    "intro": "गोरखपुर APMC के धान, गेहूं, आलू, लहसुन, प्याज और दूसरी उपलब्ध कृषि उपज के सत्यापित भाव इस पेज पर दिए जाते हैं।",
    "quality": "धान की किस्म और नमी, गेहूं की सफाई तथा आलू-प्याज-लहसुन की ताजगी और आकार मंडी बोली में अंतर ला सकते हैं।",
    "market": "पूर्वी उत्तर प्रदेश की स्थानीय आवक, परिवहन और थोक मांग के कारण अनाज और सब्जी भाव की चाल अलग हो सकती है।",
    "advice": ["Gorakhpur APMC को Chorichora या Sehjanwa APMC से अलग रखें।", "धान और गेहूं की समान तारीख व गुणवत्ता तुलना करें।", "सब्जी के पुराने रिकॉर्ड को आज का live rate न मानें।"]
  },
  "muzaffarnagar": {
    "title": "मुजफ्फरनगर मंडी भाव आज: अनाज और उपलब्ध फसल रेट",
    "intro": "Official Agmarknet में Muzzafarnagar APMC नाम से प्रकाशित धान, गेहूं, बाजरा, जौ, आलू और अन्य उपलब्ध फसल रिकॉर्ड इस पेज पर दिखते हैं।",
    "quality": "अनाज में नमी, किस्म और सफाई तथा आलू-सब्जियों में आकार और ताजगी अलग lot के भाव बदल सकते हैं।",
    "market": "क्षेत्र का गुड़-गन्ना व्यापार अलग उत्पाद श्रेणी है; इस तालिका में केवल site की verified crop mapping वाले उपलब्ध APMC रिकॉर्ड दिखते हैं।",
    "advice": ["Muzzafarnagar official spelling को Muzaffarnagar page से map किया गया है।", "Khatauli या Shahpur APMC के रिकॉर्ड इसमें न मिलाएँ।", "तालिका में न दिखने वाली फसल का भाव अनुमान से न निकालें।"]
  },
  "hapur": {
    "title": "हापुड़ मंडी भाव आज: गेहूं, धान और अनाज की दरें",
    "intro": "हापुड़ APMC के गेहूं, धान, मक्का, बाजरा, आलू और दूसरी उपलब्ध उपज के न्यूनतम, मॉडल और अधिकतम रिकॉर्ड इस पेज पर दिए जाते हैं।",
    "quality": "गेहूं, धान और मक्का में किस्म, नमी व सफाई तथा आलू में आकार-छंटाई के कारण भाव-range बदल सकती है।",
    "market": "अनाज की मौसमी आवक और स्थानीय भंडारण-खरीद मांग से हापुड़ के प्रकाशित मॉडल भाव में बदलाव आ सकता है।",
    "advice": ["Hapur APMC की exact market identity से ही रिकॉर्ड लिया गया है।", "धान, rice और गेहूं की पंक्तियों को एक-दूसरे का विकल्प न मानें।", "पुराने और fresh रिकॉर्ड का संकेत देखकर तुलना करें।"]
  },
  "saharanpur": {
    "title": "सहारनपुर मंडी भाव आज: धान, गेहूं और ताजी उपज",
    "intro": "सहारनपुर APMC के धान, गेहूं, आलू, प्याज, टमाटर, हरी मिर्च और अन्य उपलब्ध उपज के सत्यापित भाव इस पेज पर मिलते हैं।",
    "quality": "धान-गेहूं में किस्म व नमी, जबकि फल-सब्जी रिकॉर्ड में ताजगी, आकार और handling के अनुसार अलग भाव हो सकते हैं।",
    "market": "दैनिक ताजी उपज और मौसमी धान-गेहूं आवक की वजह से सहारनपुर में फसलवार रिकॉर्ड तारीख और range अलग हो सकती है।",
    "advice": ["Saharanpur APMC को Deoband, Gangoh या Chhutmalpur APMC से अलग रखें।", "ताजी उपज का भाव उसकी record date देखकर पढ़ें।", "धान की किस्म और गेहूं के grade की पुष्टि करें।"]
  },
  "mainpuri": {
    "title": "मैनपुरी मंडी भाव आज: आलू, लहसुन और अनाज के रेट",
    "intro": "मैनपुरी APMC के आलू, लहसुन, धान, गेहूं, मक्का और दूसरी उपलब्ध फसलों के सत्यापित न्यूनतम, मॉडल व अधिकतम भाव इस पेज पर दिए जाते हैं।",
    "quality": "आलू में आकार व छंटाई, लहसुन में गांठ की गुणवत्ता और नमी तथा अनाज में किस्म-सफाई बोली को प्रभावित कर सकते हैं।",
    "market": "आलू और लहसुन की स्थानीय आवक तथा धान-गेहूं के मौसमी रिकॉर्ड मैनपुरी की अलग फसल भाव-range बदल सकते हैं।",
    "advice": ["Mainpuri APMC को Bewar या Ghiraur APMC से अलग रखें।", "आलू और लहसुन के प्रति किलो रूपांतरण सही आधार पर करें।", "अनाज की तुलना समान किस्म और रिकॉर्ड तारीख में करें।"]
  }
};
