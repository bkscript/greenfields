...
MB.prices = [
  ...
  { mandi: "indore", crop: "gehun", min: 1945, modal: 2690, max: 2976, vs: 0, arrivals: "high", date: "2026-08-25", fresh: true },
  { mandi: "ujjain", crop: "gehun", min: 2441, modal: 2535, max: 3025, vs: 0, arrivals: "low", date: "2026-08-25", fresh: true },
  ...
  { mandi: "indore", crop: "chana", min: 1615, modal: 7700, max: 8910, vs: 0, arrivals: "high", date: "2026-08-25", fresh: true },
  { mandi: "ujjain", crop: "chana", min: 3913, modal: 4061, max: 4061, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "harda", crop: "makka", min: 2230, modal: 2400, max: 2400, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "amreli", crop: "kapas", min: 5500, modal: 9525, max: 10250, vs: 0, arrivals: "high", date: "2026-08-25", fresh: true },
  ...
  { mandi: "amreli", crop: "moongphali", min: 4500, modal: 6625, max: 7000, vs: 0, arrivals: "high", date: "2026-08-25", fresh: true },
  ...
  { mandi: "indore", crop: "pyaz", min: 1220, modal: 3687, max: 3818, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "mandsaur", crop: "lahsun", min: 5200, modal: 9101, max: 18200, vs: 0, arrivals: "high", date: "2026-08-25", fresh: true },
  ...
  { mandi: "indore", crop: "arhar", min: 5991, modal: 5991, max: 5991, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "amreli", crop: "gehun", min: 2300, modal: 2688, max: 2925, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "indore", crop: "lahsun", min: 4600, modal: 5300, max: 5300, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ujjain", crop: "lahsun", min: 3000, modal: 6700, max: 19100, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ujjain", crop: "aalu", min: 340, modal: 802, max: 802, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ujjain", crop: "pyaz", min: 550, modal: 3462, max: 3462, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ujjain", crop: "tamatar", min: 650, modal: 1338, max: 2130, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "neemuch", crop: "makka", min: 1675, modal: 2391, max: 2391, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "neemuch", crop: "gehun", min: 2529, modal: 2850, max: 3081, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "harda", crop: "gehun", min: 1600, modal: 2626, max: 2686, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "harda", crop: "sarson", min: 6900, modal: 7530, max: 7530, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "mandsaur", crop: "gehun", min: 1000, modal: 2600, max: 2991, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "mandsaur", crop: "moongphali", min: 6700, modal: 7401, max: 7801, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "mandsaur", crop: "makka", min: 2231, modal: 2389, max: 2389, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "mandsaur", crop: "sarson", min: 7000, modal: 7452, max: 7487, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "mandsaur", crop: "pyaz", min: 2881, modal: 3901, max: 3901, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "neemuch", crop: "moongphali", min: 5260, modal: 7270, max: 7270, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ratlam", crop: "pyaz", min: 700, modal: 3400, max: 4300, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ratlam", crop: "gehun", min: 2460, modal: 2646, max: 2979, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ratlam", crop: "lahsun", min: 2100, modal: 5700, max: 18200, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "ramganj", crop: "aalu", min: 400, modal: 1100, max: 2000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "pyaz", min: 1800, modal: 4200, max: 4500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "tamatar", min: 500, modal: 2000, max: 3000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "gehun", min: 2450, modal: 2450, max: 2450, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "makka", min: 2050, modal: 2050, max: 2050, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "panipat", crop: "pyaz", min: 1000, modal: 1500, max: 2000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "panipat", crop: "tamatar", min: 700, modal: 1000, max: 1300, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "panipat", crop: "aalu", min: 1000, modal: 1200, max: 1400, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "amreli", crop: "arhar", min: 4500, modal: 6500, max: 7275, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "amreli", crop: "jeera", min: 15075, modal: 15250, max: 15250, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "amreli", crop: "jowar", min: 2875, modal: 5500, max: 6300, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "amreli", crop: "arandi", min: 6625, modal: 6825, max: 6825, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "amreli", crop: "til", min: 6950, modal: 12100, max: 17075, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "amreli", crop: "chana", min: 5000, modal: 6050, max: 6250, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "indore", crop: "moong", min: 5995, modal: 6965, max: 6965, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "neemuch", crop: "hara-dhaniya", min: 13750, modal: 14501, max: 14550, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "neemuch", crop: "chana", min: 2850, modal: 5550, max: 6250, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "neemuch", crop: "isabgol", min: 7778, modal: 10000, max: 13510, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "neemuch", crop: "masoor", min: 5300, modal: 8350, max: 8350, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "neemuch", crop: "til", min: 10200, modal: 11600, max: 11600, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "neemuch", crop: "alsi", min: 9741, modal: 9900, max: 9900, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "neemuch", crop: "urad", min: 5200, modal: 8051, max: 8051, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ratlam", crop: "chana", min: 5350, modal: 7725, max: 9250, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ratlam", crop: "hara-matar", min: 2601, modal: 5140, max: 5140, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "ramganj", crop: "amrood", min: 3500, modal: 4000, max: 4500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "anar", min: 3800, modal: 8000, max: 13000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "seb", min: 3000, modal: 10000, max: 12000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "adrak", min: 4000, modal: 10000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "hara-dhaniya", min: 10000, modal: 12000, max: 15000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "hara-matar", min: 4000, modal: 5000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "dhan", min: 2325, modal: 2325, max: 2335, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ramganj", crop: "kela", min: 850, modal: 2700, max: 4800, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "panipat", crop: "kela", min: 2000, modal: 2500, max: 3000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "panipat", crop: "amrood", min: 2000, modal: 2500, max: 3000, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "panipat", crop: "seb", min: 4000, modal: 8000, max: 12000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "panipat", crop: "anar", min: 4000, modal: 6000, max: 8000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "mandsaur", crop: "til", min: 10150, modal: 10324, max: 10499, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "mandsaur", crop: "alsi", min: 7801, modal: 9175, max: 9453, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "mandsaur", crop: "chana", min: 4431, modal: 6284, max: 6667, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "mandsaur", crop: "hara-matar", min: 2580, modal: 2580, max: 2580, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "mandsaur", crop: "jau", min: 2301, modal: 2740, max: 2740, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "ujjain", crop: "sarson", min: 7290, modal: 7290, max: 7290, vs: 0, arrivals: "med", date: "2026-08-22", fresh: false },
  { mandi: "ujjain", crop: "moong", min: 6051, modal: 6051, max: 6051, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "amreli", crop: "methi", min: 6000, modal: 6575, max: 7025, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "neemuch", crop: "methi", min: 6421, modal: 7231, max: 7231, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "mandsaur", crop: "methi", min: 900, modal: 6010, max: 6711, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "goluwala", crop: "gwar", min: 5700, modal: 5950, max: 5980, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "goluwala", crop: "tamatar", min: 2000, modal: 3000, max: 3000, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "goluwala", crop: "pyaz", min: 3400, modal: 3500, max: 3500, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "goluwala", crop: "sarson", min: 7271, modal: 7656, max: 7876, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "goluwala", crop: "aalu", min: 600, modal: 700, max: 700, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "goluwala", crop: "gehun", min: 2525, modal: 2566, max: 2611, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  { mandi: "goluwala", crop: "chana", min: 5750, modal: 5750, max: 5750, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  ...
  { mandi: "amreli", crop: "urad", min: 6425, modal: 8500, max: 8500, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "mandsaur", crop: "asaliya", min: 5750, modal: 5750, max: 5750, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "neemuch", crop: "sarson", min: 6500, modal: 7330, max: 7633, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  { mandi: "neemuch", crop: "kalonji", min: 17000, modal: 18560, max: 18560, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "amreli", crop: "sarson", min: 7500, modal: 8200, max: 8200, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "ramganj", crop: "hari-mirch", min: 500, modal: 1800, max: 6000, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
  ...
  { mandi: "goluwala", crop: "jau", min: 2251, modal: 2251, max: 2271, vs: 0, arrivals: "med", date: "2026-08-24", fresh: false },
  ...
  { mandi: "jodhpur", crop: "sua-patti", min: 50, modal: 56, max: 70, vs: 0, arrivals: "med", date: "2026-08-25", fresh: true },
